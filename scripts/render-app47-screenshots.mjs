...
// produced by `render-app47-preview.mjs`, at their intended breakpoints.
...
const SCREENS = ['app04-scan', 'app04-scan-overlay', 'app05-scan-session', 'app06-deck-editor', 'app07-me'];
  ...
  for (const screen of SCREENS) {
    for (const { width, height, label } of WIDTHS) {
      ...
      if (!existsSync(htmlPath)) {
        throw new Error(`Missing preview HTML: ${htmlPath}. Run render:app47 first.`);
      }
