...
// produced by `render-app-screens-preview.mjs`, at their intended breakpoints.
...
const SCREENS = ['app01-home', 'app02-search-results', 'app03-card-detail'];
  ...
  for (const screen of SCREENS) {
    for (const { width, height, label } of WIDTHS) {
      ...
      if (!existsSync(htmlPath)) {
        throw new Error(`Missing preview HTML: ${htmlPath}. Run render:app-screens first.`);
      }
