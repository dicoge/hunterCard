...
console.log(`✓ official catalog completeness gate passed: ${products.length} products, ${officialTotal} official rows, skills/name/image coverage complete in canonical and public databases`);
