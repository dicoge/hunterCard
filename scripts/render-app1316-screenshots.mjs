...
// produced by `render-app1316-preview.mjs`, at their intended breakpoints.
...
const SCREENS = ['app13-tutorial-detail', 'app14-tutorial-simulation', 'app15-settings', 'app16-login'];
  ...
  for (const screen of SCREENS) {
    for (const { width, height, label } of WIDTHS) {
      ...
      if (!existsSync(htmlPath)) {
        throw new Error(`Missing preview HTML: ${htmlPath}. Run render:app1316 first.`);
      }
